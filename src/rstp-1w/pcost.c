...
static long
computeAutoPCost (STATE_MACH_T *self)
{
    long lret;
...
static void
updPortPathCost (STATE_MACH_T *self)
{
}

void
STP_pcost_enter_state (STATE_MACH_T *self)
{
  register PORT_T*  port = self->owner.port;
...
Bool
STP_pcost_check_conditions (STATE_MACH_T* self)
{
  register PORT_T*  port = self->owner.port;
