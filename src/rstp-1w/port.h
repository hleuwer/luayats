...
void
STP_port_delete (PORT_T* self);

int
STP_port_rx_bpdu (PORT_T* self, BPDU_T* bpdu, size_t len);

void
STP_port_init (PORT_T* self, struct stpm_t* stpm, Bool check_link);

#ifdef STP_DBG
int
STP_port_trace_state_machine (PORT_T* self, char* mach_name, int enadis, int vlan_id);

void
STP_port_trace_flags (char* title, PORT_T* self);
#endif
