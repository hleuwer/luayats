...
int             /* 1- Up, 0- Down */
STP_OUT_get_port_link_status (rstp_bridge *rstp, int port_index)
{
  if (BitmapGetBit (&rstp->enabled_ports, (port_index - 1))) return 1;
  return 0;
}
...
int
STP_OUT_tx_bpdu (int port_index, rstp_bridge *rstp, int vlan_id,
