...
#else
//tolua_begin
#define BR_CFG_ALL BR_CFG_STATE | BR_CFG_PRIO | BR_CFG_AGE | BR_CFG_HELLO | BR_CFG_DELAY | BR_CFG_FORCE_VER | BR_CFG_AGE_MODE | BR_CFG_AGE_TIME | BR_CFG_HOLD_TIME
#endif
typedef struct {
  /* service data */
...
#else
//tolua_begin
#define PT_CFG_ALL PT_CFG_STATE  | PT_CFG_COST   | PT_CFG_PRIO   | PT_CFG_P2P    | PT_CFG_EDGE   |  PT_CFG_MCHECK | PT_CFG_NON_STP                  
#endif
