...
#define STP_OUT_get_init_port_pathcost(rstp, port)      rstp->get_init_pathcost(port)
...
int /* 1- Up, 0- Down */
STP_OUT_get_port_link_status (IN rstp_bridge *rstp, IN int port_index);
...
int
STP_OUT_tx_bpdu (IN int port_index, IN rstp_bridge *rstp, int vlan_id,
