...
#ifdef DELETME
#define TxHoldCount          6 /* 17.16.6, 17.28.2(Table 17-5) */
#else
extern PORT_TIMER_T TxHoldCount;
#endif
class rstp_bridge;
...
typedef struct stpm_t {
  ...
  rstp_bridge *rstp; //leu: we keep a reference to our our bridge
  int                   debug;
} STPM_T;
...
int STP_stpm_update (STPM_T* self);
