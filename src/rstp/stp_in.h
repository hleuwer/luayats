...
#define DEF_AUTO_EDGE        True            /*kd: ich meine, dass diese define hier bleiben soll*/
...
#ifdef _UID_STP_H__
int STP_IN_stpm_get_cfg (rstp_bridge *rstp, int vlan_id, UID_STP_CFG_T* uid_cfg);
int STP_IN_stpm_get_state (rstp_bridge *rstp, int vlan_id, UID_STP_STATE_T* entry);
int STP_IN_port_get_cfg (rstp_bridge *rstp, int vlan_id, int port_index, UID_STP_PORT_CFG_T* uid_cfg);
int STP_IN_port_get_state (rstp_bridge *rstp, int vlan_id, UID_STP_PORT_STATE_T* entry);
#endif

/* Section 3. "Set" management */

int STP_IN_stpm_set_cfg (rstp_bridge *rstp, int vlan_id,
                     BITMAP_T* port_bmp,
                     UID_STP_CFG_T* uid_cfg);
int STP_IN_set_port_cfg (rstp_bridge *rstp, int vlan_id,
...
/* for Link UP/DOWN leu: NO use STP_IN_up_port instead */
...
int stp_in_stpm_enable(rstp_bridge *rstp, int vlan_id, BITMAP_T* port_bmp, UID_STP_MODE_T admin_state);
