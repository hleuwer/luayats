...
typedef struct port_t {
...
#if 0 /* leu: replaced by brdec state machine */
  STATE_MACH_T*     edge;      /*  */
#endif
  STATE_MACH_T*     pcost;     /*  */
  STATE_MACH_T*     portrec;    /* kd: new in 802.1D */
  STATE_MACH_T*     brdec;      /* kd: new in 802.1D */
  ...
  /* per port Timers */
  PORT_TIMER_T	    edgeDelayWhile; /* kd: 802.1D page 158 */
  ...
  Bool              rcvdMsg;       /* 17.18.22 */   /*izmenim na bool*/
  RCVD_MSG_T	    rcvdInfo;  
...
void STP_port_init (PORT_T* self, struct stpm_t* stpm, Bool check_link);
