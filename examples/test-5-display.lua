...
meter = yats.meter:new{"meter", val={mx,"QLen"}, title = "QLEN-meter", win={500, 100, 400, 200}, nvals = 100, delta = 1000, mode=yats.AbsMode, maxval = 20, linemode=1, display=false}
...
disp = yats.display:new{"DISPLAY", width=200, height=100, instrument=meter}
--disp:attach(meter)
