...
-- Server Distribution
dgeo = yats.distrib{"dgeo", dist=yats.distrib.geometric, distargs={e=1}}
dbin = yats.distrib{"dbin", dist=yats.distrib.binomial, distargs={n=20, p=0.5}}

-- Create Multiplexer
-- Tip: choose dbin for a nice histogram of IAT
mx = yats.muxDist{"mux", ninp=nsrc, dist=dbin, buff=10, out={"demux", "demux"}}
