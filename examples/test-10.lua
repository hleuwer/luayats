...
-- Create Multiplexer
mx = yats.mux{"mux", ninp=nsrc, buff=10, out={"trc", "tracer"}}
print("object '"..mx.name.."' of class '"..(mx.clname or "unknown").."' created.", mx)
trc = yats.tracer{"trc", vci = 1, out={"demux", "demux"}}
print("object '"..trc.name.."' of class '"..(trc.clname or "unknown").."' created.", trc)
