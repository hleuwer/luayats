...
--  bgcolor = cd.YELLOW,
  ...
  usepoly = 0,
  polystep = 0,
  polytype = cd.OPEN_LINES,
--  canvastype = yats.CDTYPE_SERVERIMG
  canvastype = yats.CDTYPE_DBUFFER
}
...
bs_deterministics = bs_deterministics or 1
...
--  title="AGERETM", nrow=3, ncol=8, width=100, height=100, 
  ...
  bigdisp = {
    yats.bigdisplay{
      "bigdisp-1",
      title="INGRESS", nrow=3, ncol=3, width=100, height=100, attrib=defattrib,
      instruments= {
    ...
    yats.bigdisplay{
      "bigdisp-3",
      title="EGRESS", nrow=3, ncol=3, width=150, height=100, attrib=defattrib,
      instruments = {
